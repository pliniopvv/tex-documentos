...
\textbf{Interessado:} \input{temp/interessado.tex}
%\setlength{\parskip}{0cm}
\begin{center}
\textbf{Data, local e horário das amostragens}
\end{center}
%\setlength{\parskip}{0cm}
\input{temp/dados_empresa.tex}

Funcionário \textbf{Responsável} pelo empreendimento: \textbf{\input{temp/func_empresa_responsavel.tex}} \\
\begin{tiny}
Responsável: \input{temp/func_resp_relatorio.tex}
\end{tiny}
\end{SingleSpacing}
